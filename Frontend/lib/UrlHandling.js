...
const urlFinder = /(?:(?:http[s]?:\/\/|ftp:\/\/|mailto:[-a-z0-9:?.=/_@]+)|(?:[a-z0-9-.]+\.(?:com|org|net|tv|gg|us|uk|co\.uk|edu|gov|mil|biz|info|moby|ly|tech|xyz|ca|cn|fr|au|in|de|jp|ru|br|es|se|ch|nl)\/)|(?:localhost:))\S*/gim;
export { urlFinder };
