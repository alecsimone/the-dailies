...
const urlFinder = new RegExp(
   `(?:\\[(.+)\\]\\((.+)\\))|(?:\\[[pPtT]:".+"\\])|(?:(?:http[s]?:\\/\\/|ftp:\\/\\/|mailto:[-a-z0-9:?.=/_@]+)${urlAcceptableCharacters}*|(?:(${urlAcceptableCharacters}+)\\.(?:${topLevelDomains})(?:(?=\\s|[,.;]|$)|\\/${urlAcceptableCharacters}*))|(?:localhost:)${urlAcceptableCharacters}*)`,
   'gim'
);
export { urlFinder };
